...
class StudentResume
{
    ...
    static void Main()
    {
        ...
        Console.WriteLine("File Name: " + sr.FileName);
        Console.WriteLine("File Size: " + sr.FileSize);
        Console.WriteLine("File Location: " + sr.FileLocation);
        Console.WriteLine("File Create Date: " + sr.CreatedDate);
    }
